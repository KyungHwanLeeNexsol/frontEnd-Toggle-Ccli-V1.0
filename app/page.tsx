      ...
      <div className="layout pt-[96px] sm:pt-[134px]">
        ...
        <header className="w-full fixed top-0 z-[100] bg-white ">
          <div className="inner flex justify-between py-8 px-4 sm:px-[60px] sm:pr-[50px] sm:pb-7 sm:pt-[50px]">
            <div className="flex items-center gap-[40px]">
              ...
              <Link href="" className="font-bold hidden lg:block">
                회사소개
              </Link>
              <button
                type="button"
            ...
            >
              <Image
                ...
                height={20}
              />
              <p className="text-white font-bold">우리 회사에 도입하기</p>
            </Link>
        ...
        >
          ...
          >
            ...
            <p className="text-white text-[32px] leading-[41.6px] font-extrabold block lg:hidden">
              예상치 못한
              <br />
              중대재해의 위험,
              <br />
          ...
          <div className="text-center">
            ...
            <p className="text-[12px] sm:text-[16px] text-[#8D94A0] leading-[15.12px] sm:leading-[20.8px] mb-6 sm:mb-10">
              중대재해처벌법: 2024.01부 기업(5인 이상의 모든 사업장)으로 확대
              시행
            </p>
            <button
              type="button"
              className="text-primary font-bold leading-[22.4px] py-4 px-8 rounded-[16px] border-[2px] border-solid border-primary"
              onClick={() => goToSection4()}
            >
              중대재해보험에 대해 자세히 알아보세요
            </button>
        ...
        <div id="container" className="inner">
          <section className="section1">
            ...
            <p className="text-[12px] sm:text-[16px] text-[#6B7583] font-normal leading-[15.12px] sm:leading-[20.8px]">
          ...
          <section className="section2">
            ...
            <div className="flex justify-between flex-col lg:flex-row gap-5 mb-6 sm:mb-[64px]">
              <div className="box-wrap">
                ...
                <div className="flex flex-col gap-2  mb-6 sm:mb-[48px]">
                  <dl>
                ...
                <div className="w-full sm:max-w-max mx-auto">
                  <Image
                    ...
                    className="w-full"
                  />
                  <p className="w-full sm:w-auto text-[12px] text-[#D2D6DB] text-right leading-[15.12px] mt-[7px] sm:mt-6">
                    * 자료출처: 연합뉴스
                  </p>
                </div>
              </div>
            ...
            <p className="flex items-start gap-1.5 sm:gap-2 text-[16px] sm:text-[20px] leading-[20.8px] sm:leading-[30px]">
              <Image
          ...
          <section className="section3">
            ...
            <div className="flex justify-between flex-col md:flex-row gap-5">
              <div className="box-wrap">
                ...
                <p className="text-[#6B7583] text-[12px] leading-[15.12px] mt-4">
          ...
          <section className="section4" ref={section4Ref}>
            ...
            <div className="bg-[rgba(88,134,254,0.1)] border-[1px] border-solid border-[#5886FE] rounded-[20px]">
              ...
              <div className="md:p-10 md:pt-5">
                <div className="bg-primary rounded-[20px] p-4 pt-[30px] md:p-[40px]">
                  <p className="max-w-max text-[20px] md:text-[24px] text-[#2250C3] font-bold leading-[26px] md:leading-[31.2px] bg-white mx-auto mb-8 md:mb-[60px] py-1.5 px-4 rounded-[12px]">
                    간편한 보험 가입 서비스
                  </p>
                  ...
                  <div>
                    <ol>
                      ...
                      <li>
                        ...
                        <ul>
                          <li>소 7일 이상 소요되는 대면 가입 절차 간소화</li>
          ...
          <div className="px-4 sm:px-[60px] pb-[40px] sm:pb-[80px]">
            ...
            >
              ...
              <p className="text-[24px] lg:text-[32px] text-white text-center font-bold leading-[31.2px] lg:leading-[41.6px]">
                중대재해보험으로
                <br />
        ...
        <footer className="bg-[#F9FAFB] text-[#6B7583]">
          <div className="inner flex flex-col gap-4 sm:gap-6 py-[60px] sm:py-[120px] px-4 sm:px-[60px]">
            ...
            <div className="flex flex-col xl:flex-row xl:justify-between xl:items-center gap-6 xl:gap-0 text-[12px] sm:text-[16px] leading-[15.12px] sm:leading-[20.8px]">
              <div>
                대표이사: 이광현 / 사업자등록번호: 154-87-01568 / 주소: 04797
                서울특별시 성동구 아차산로11길 18 907호(성수동,쁘랭땅빌딩)
                <br />
                통신판매업번호: 제2021-서울 서초-1551호 / 대표전화: 1661-4045
              </div>
